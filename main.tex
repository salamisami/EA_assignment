...
\newline \textbf{Askar Sami}:
	\begin{itemize}
		\item Section \ref{sec:evo_train} "Evolutionary Training with Human Data and Jenetics"
        \item Maintained project repository and set up GitHub workflow \cite{rmb_github}
    \end{itemize}
