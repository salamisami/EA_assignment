...
\author{Askar Sami} %this should start the github workflow
...
\Description[A Small Frog looking straight]{A small Frog on a leaf looking straight at the camera/viewer with orange eyelids.}
\end{figure}
