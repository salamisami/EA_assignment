 ...
 */
public class ClientOutput extends EventDispatcherBase implements ServerInterface {
    ...
    public void createGame(Session session, String gameName) {
        createGame(new Event(new Object[] {session, gameName}));
    }
    ...
    public void joinGame(Session session, String gameName) {
        joinGame(new Event(new Object[] {session, gameName}));
    }
    ...
    public void login1(String username) {
        login1(new Event(new Object[]{username}));
    }
    ...
    @Override
    public void continueGame(Event event) {
