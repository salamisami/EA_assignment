...
public class LoadingPanel extends javax.swing.JPanel {
     ...
     * @param gameName */
    public LoadingPanel(String gameName) {
        this.gameName = gameName;
        this.background = Resource.getImage("res/gfx/waitscreen.jpg").getImage();
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(btnStartGame)
                .add(18, 18, 18)
                .add(filler2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 0, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnStartGameActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ClientThread.getInstance().getServer().startGame(new Event(
                    new Object[] {
                            games.homeship.robomazeblast.client.ClientThread
