...
class ExtraDistance extends Extra {
    ...
    private static final long  serialVersionUID = 7243922604140793033L;
    public static final String IMAGE_FILENAME   = "res/gfx/extras/bombDistance.png";

    protected ExtraDistance() {
